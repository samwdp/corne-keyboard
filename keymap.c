...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[_BASE] = LAYOUT_split_3x6_3(
    ...
    KC_CAPS, LT(_NUMBERS, KC_TAB), LSFT_T(KC_ENT), LT(_NUMBERS, KC_SPC), LT(_SYMBOLS, KC_BSPC), KC_DEL),
        ...
        KC_HOME, KC_INS, KC_ENT, KC_SPC, KC_TRNS, KC_RALT),
                                                              ...
                                                              [_GAMINGNUMBERS] = LAYOUT_split_3x6_3(KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_TILD, KC_P1, KC_P2, KC_P3, KC_P4, KC_P5, KC_P6, KC_P7, KC_P8, KC_P9, KC_P0, KC_HOME, KC_NO, KC_NUM, KC_NO, KC_NO, KC_LALT, KC_LCTL, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_INS, KC_END, KC_TRNS, KC_RALT, KC_SPC, KC_SPC, KC_NO, KC_LGUI)};
